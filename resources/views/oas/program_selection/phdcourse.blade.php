...
<div class="container mb-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h2 class="fw-bold mb-3">Add/Hide Courses - <span class="text-success">PhD Course</span></h2>
                        ...
                        *Click the course to hide it
                        <div class="card-body">
                            <form>
                                ...
                                <div class="row mb-3">
                                    <a class="btn btn-primary" href="phdcourse">PhD Courses2</a>
                                </div>

                                <div class="row mb-3">
                                    <a class="btn btn-primary" href="phdcourse">PhD Courses3</a>
                                </div>

                                <div class="row mb-3">
                                    <a class="btn btn-primary" href="phdcourse">PhD Courses4</a>
                                </div>

                                <div class="row mb-3">
                                    <a class="btn btn-primary" href="phdcourse">PhD Courses5</a>
                                </div>
