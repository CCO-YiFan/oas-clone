...
@elseif($application_status_id >= config('constants.APPLICATION_STATUS_CODE.COMPLETE_SUPPORTING_DOCUEMENT'))
    <script>$(function(){$('#statusCode9Modal').modal('show');});</script>
@endif
...
<div class="container mb-4">
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="fw-bold">Supporting Document</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <p><span class="fw-bold">Step 6 of 7</span> Completed</p>
                <div class="progress mb-2" style="height: 10px;">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" role="progressbar" style="width: 73%" aria-valuenow="73" aria-valuemin="0" aria-valuemax="100"></div>
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-secondary opacity-25" role="progressbar" style="width: 27%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
        </div>
    </div>
</div>
                            ...
                            <div class="col-md-12 table-responsive">
                                <table class="table table-bordered border-primary">
                                    ...
                                    <tbody>
                                        ...
                                        {{--Master Transcript--}}
                                        <tr>
                                            <td>Master Transcript</td>
                                            <td><input class="form-control me-3 mb-2" id="master_transcript" name="master_transcript" type="file" accept=".jpg, .jpeg" onchange="previewMasterTranscript(event)"></td>
                                            <td><img id="preview_master_transcript_location" name="preview_ic_back_location" class="img-fluid"></td>
                                        </tr>
                                        {{--PhD Transcript--}}
                                        </tr>
...
<script>
    ...
    var previewMasterTranscript = function(event){
        var previewLocation = document.getElementById('preview_master_transcript_location');
        previewLocation.src = URL.createObjectURL(event.target.files[0]);
        previewLocation.onload = function(){
            URL.revokeObjectURL(previewLocation.src);
        }
