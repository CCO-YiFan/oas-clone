...
@section('content')
    ...
    @elseif($application_status_id >= 11)
...
<div class="container mb-4">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h2 class="fw-bold mb-3">{{ __('payment.title') }}</h2>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" role="progressbar" aria-label="Animated striped example" style="width: 96%" aria-valuenow="96" aria-valuemin="0" aria-valuemax="100" >{{ __('payment.current_step') }}</div>
                <span class="text-primary ms-3 fw-bold">{{ __('payment.next_step') }}</span>
            </div>
        </div>
    </div>
</div>
