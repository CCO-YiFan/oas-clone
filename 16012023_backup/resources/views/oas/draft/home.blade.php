...
@section('content')
    ...
    @elseif($application_status_id >= 9)
    ...
    <div class="modal fade" id="statusCode9Modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="statusCode4ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header"><h1 class="modal-title fs-5" id="statusCode9ModalLabel">{{ __('modal.congratulations') }}</h1></div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="{{ route('home') }}" type="button" class="btn btn-outline-secondary">{{ __('modal.back_to_home_button') }}</a>
                    <a href="{{ route('supporting_document.supporting_document') }}" type="button" class="btn btn-primary">{{ __('modal.continue') }}</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container mb-4">
    <div class="row">
        <div class="col-md-12">
            <h2 class="fw-bold mb-3">{{ __('draft.title') }}</h2>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" role="progressbar" aria-label="Animated striped example" style="width: 70%" aria-valuenow="84" aria-valuemin="0" aria-valuemax="100" >{{ __('draft.current_step') }}</div>
                <span class="text-primary ms-3 fw-bold">{{ __('draft.next_step') }}</span>
            </div>
        </div>
    </div>
</div>
       ...
       <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row px-3 mt-3 mb-3">
                        <div class="card-header bg-primary text-white px-2 py-2 d-flex justify-content-between align-items-center">
                            {{ __('personalParticulars.pageTitle') }}
                        ...
                        <div class="col-sm-12 pt-2">
                            ...
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('personalParticulars.permanent_address') }} </p>
                    ...
                    <div class="row px-3 mt-3 mb-3">
                        <div class="card-header bg-primary text-white px-2 py-2 d-flex justify-content-between align-items-center">
                            {{ __('parentGuardianParticulars.pageTitle') }}
                        ...
                        <div class="col-sm-12 pt-2">
                            ...
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.ch_name') }} </p>
                                <p class="lead col-sm-6 fw-bold">: {{ $guardian_user_detail->ch_name }}</p>
                            </div>
                            @endif
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.en_name') }} </p>
                                <p class="lead col-sm-6 fw-bold text-capitalize">: {{ $guardian_user_detail->en_name }}</p>
                            </div>
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.ic') }} </p>
                                <p class="lead col-sm-6 fw-bold" id="read_ic">: {{ $guardian_user_detail->ic }}</p>
                            </div>
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.income_range') }} </p>
                                <p class="lead col-sm-6 fw-bold">: {{ $getGuardianDetail->income['range'] }}</p>
                            </div>
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.relationship') }} </p>
                                <p class="lead col-sm-6 fw-bold">: {{ $getGuardianDetail->guardianRelationship['name'] }}</p>
                            </div>
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.occupation') }} </p>
                                <p class="lead col-sm-6 fw-bold">: {{ $getGuardianDetail->occupation }}</p>
                            </div>
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.nationality') }} </p>
                                <p class="lead col-sm-6 fw-bold">: {{ $getGuardianDetail->nationality['name'] }}</p>
                            </div>
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.tel_hp') }} </p>
                                <p class="lead col-sm-6 fw-bold">: {{ $guardian_user_detail->tel_hp }}</p>
                            </div>
                            @if($guardian_user_detail->email !=null)
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.email_address') }} </p>
                                <p class="lead col-sm-6 fw-bold">: {{ $guardian_user_detail->email }}</p>
                            </div>
                            @endif
                            <div class="d-flex flex-row">
                                <p class="lead col-sm-6">{{ __('parentGuardianParticulars.permanent_address') }} </p>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($academicRecord as $ar)
                                            <tr>
                                                <td><p name="school_level" id="school_level">{{ $ar->school_level['name'] }} <span></p></td>
                                                <td><p>{{ $ar->school_name }}</p></td>
                                                <td><p>{{ $ar->school_graduation }}</p></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><p>{{ $SOH->disease['name'] }}</p></td>
                                            <td><p>{{ $SOH->disease_status }}</p></td>
                                            <td><p>{{ $SOH->disease_remark }}</p></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-end mb-3 mt-3">
                        <a href="/agreements" class="btn btn-secondary me-3">{{ __('draft.back_button') }}</a>
        ...
        <form action="{{ route('emergencyContact.update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h1 class="modal-title fs-5" id="editModalLabel">{{ __('emergencyContact.edit_button') }}</h1>
                            ...
                            <div class="col-md-12">
                                <div class="row g-2">
                                    <div class="col-md mb-3">
                                        ...
                                        <input type="text" name="en_name1" id="en_name1" class="form-control text-capitalize" value="{{ $e_user_detail1->en_name }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md mb-3">
                                        ...
                                        <input type="text" name="tel_hp1" id="tel_hp1" class="form-control" value="{{ $e_user_detail1->tel_hp }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row g-2">
                                    <div class="col-md mb-3">
                                        <label for="en_name" class="form-label">{{ __('emergencyContact.en_name') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="en_name2" id="en_name2" class="form-control text-capitalize" value="{{ $e_user_detail2->en_name }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="ch_name" class="form-label">{{ __('emergencyContact.ch_name') }}</label>
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md mb-3">
                                        <label for="tel_hp" class="form-label">{{ __('emergencyContact.tel_hp') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="tel_hp2" id="tel_hp2" class="form-control" value="{{ $e_user_detail2->tel_hp }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="fw-bold">{{ __('emergencyContact.pageTitle') }}</h4>
                                <p class="text-secondary">{{ __('emergencyContact.name_description') }}</p>
                            </div>
                            <div class="col-md-12">
                                <div class="row g-2">
                                    <div class="col-md mb-3">
                                        <label for="en_name" class="form-label">{{ __('emergencyContact.en_name') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="en_name" id="en_name" class="form-control text-capitalize" value="{{ $guardian_user_detail->en_name }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="ch_name" class="form-label">{{ __('emergencyContact.ch_name') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="fw-bold">{{ __('emergencyContact.identity_card_passport') }}</h4>
                                <p class="text-secondary">{{ __('emergencyContact.ic_description1') }}</p>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="changeInput">
                                        {{ __('emergencyContact.ic_checkbox') }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="row" id="ic_section">
                                    <label for="ic" class="form-label">{{ __('emergencyContact.ic') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="row" id="passport_section" style="display: none;">
                                    <label for="ic" class="form-label">{{ __('emergencyContact.passport') }}<span class="text-danger">*</span></label>
                                    <div class="col-md mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="fw-bold">{{ __('emergencyContact.relationship_nationality') }}</h4>
                            </div>
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        <label for="relationship" class="form-label">{{ __('emergencyContact.relationship') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md mb-3">
                                        <label for="nationality" class="form-label">{{ __('emergencyContact.nationality') }}<span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="fw-bold">{{ __('emergencyContact.occupation_family_income') }}</h4>
                            </div>
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        <label for="occupation" class="form-label">{{ __('emergencyContact.occupation') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="occupation" id="occupation" class="form-control" value="{{ $getGuardianDetail->occupation }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="income" class="form-label">{{ __('emergencyContact.income_range') }}<span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="fw-bold">{{ __('emergencyContact.contact') }}</h4>
                            </div>
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md mb-3">
                                        <label for="tel_hp" class="form-label">{{ __('emergencyContact.tel_hp') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="tel_hp" id="tel_hp" class="form-control" value="{{ $guardian_user_detail->tel_hp }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="email" class="form-label">{{ __('emergencyContact.email_address') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="fw-bold">{{ __('emergencyContact.permanent_address') }}</h4>
                            </div>
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        <label for="p_street1" class="form-label">{{ __('emergencyContact.address_line1') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="p_street1" id="p_street1" class="form-control" value="{{ $g_p_address->street1 }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="p_street2" class="form-label">{{ __('emergencyContact.address_line2') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="p_street2" id="p_street2" class="form-control" value="{{ $g_p_address->street2 }}" required>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        <label for="p_zipcode" class="form-label">{{ __('emergencyContact.zipcode') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="p_zipcode" id="p_zipcode" class="form-control" value="{{ $g_p_address->zipcode}}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="p_city" class="form-label">{{ __('emergencyContact.city') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="p_city" id="p_city" class="form-control" value="{{ $g_p_address->city }}" required>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        <label for="p_state" class="form-label">{{ __('emergencyContact.state') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="p_state" id="p_state" class="form-control" value="{{ $g_p_address->state }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="p_country" class="form-label">{{ __('emergencyContact.country') }}<span class="text-danger">*</span></label>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <form action="{{ route('personalParticulars.update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                            ...
                            <div class="col-md-12">
                                <div class="row g-2">
                                    <div class="col-md mb-3">
                                        ...
                                        <input type="text" name="en_name" id="en_name" class="form-control text-capitalize" value="{{ $getPersonalUserDetail->en_name }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row" id="ic_section_personal">
                                    <label for="ic_personal" class="form-label">{{ __('personalParticulars.ic') }}<span class="text-danger">*</span></label>
                                    <div class="col-md d-flex flex-row align-items-center mb-3">
                                        <input type="text" name="ic1" id="ic1_personal" class="form-control" placeholder="" maxlength="6" required>
                                        <span class="ms-4">-</span>
                                    </div>
                                    <div class="col-md d-flex flex-row align-items-center mb-3">
                                        <input type="text" name="ic2" id="ic2_personal" class="form-control" placeholder="" maxlength="2" required>
                                        <span class="ms-4">-</span>
                                    </div>
                                    <div class="col-md mb-3">
                                        <input type="text" name="ic3" id="ic3_personal" class="form-control" placeholder="" maxlength="4" required>
                                    </div>
                                </div>
                                <div class="row" id="passport_section_personal" style="display: none;">
                                    ...
                                    <div class="col-md mb-3">
                                        <input type="text" name="passport" id="passport_personal" class="form-control" placeholder="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md mb-3">
                                        <label for="nationality_personal" class="form-label">{{ __('personalParticulars.nationality') }}<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md mb-3">
                                        ...
                                        <input type="text" name="tel_hp" id="tel_hp" class="form-control" value="{{ $getPersonalUserDetail->tel_hp }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                            <label for="tel_h" class="form-label">{{ __('personalParticulars.tel_h') }}</label>
                                            <input type="text" name="tel_h" id="tel_h" class="form-control" value="{{ $getPersonalUserDetail->tel_h }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        ...
                                        <input type="text" name="c_street1" id="c_street1" class="form-control" value="{{ $p_c_address->street1 }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="c_street2" class="form-label">{{ __('personalParticulars.address_line2') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="c_street2" id="c_street2" class="form-control" value="{{ $p_c_address->street2 }}" required>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        <label for="c_zipcode" class="form-label">{{ __('personalParticulars.zipcode') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="c_zipcode" id="c_zipcode" class="form-control" value="{{ $p_c_address->zipcode }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="c_city" class="form-label">{{ __('personalParticulars.city') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="c_city" id="c_city" class="form-control" value="{{ $p_c_address->city }}" required>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        <label for="c_state" class="form-label">{{ __('personalParticulars.state') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="c_state" id="c_state" class="form-control" value="{{ $p_c_address->state }}" required>
                                    </div>
                                    <div class="col-md">
                            ...
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        ...
                                        <input type="text" name="p_street1" id="p_street1" class="form-control" value="{{ $p_p_address->street1 }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="p_street2" class="form-label">{{ __('personalParticulars.address_line2') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="p_street2" id="p_street2" class="form-control" value="{{ $p_p_address->street2 }}" required>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        <label for="p_zipcode" class="form-label">{{ __('personalParticulars.zipcode') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="p_zipcode" id="p_zipcode" class="form-control" value="{{ $p_p_address->zipcode }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                                        <label for="p_city" class="form-label">{{ __('personalParticulars.city') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="p_city" id="p_city" class="form-control" value="{{ $p_p_address->city }}" required>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col-md mb-3">
                                        <label for="p_state" class="form-label">{{ __('personalParticulars.state') }}<span class="text-danger">*</span></label>
                                        <input type="text" name="p_state" id="p_state" class="form-control" value="{{ $p_p_address->state }}" required>
                                    </div>
                                    <div class="col-md mb-3">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ __('personalParticulars.close_button') }}</button>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <form action="{{ route('academicDetail.update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($academicRecord as $ar)
                                    <tr>
                                        <td><p name="school_level[{{ $ar->school_level['id'] }}]" id="school_level">{{ $ar->school_level['name'] }} <span></p></td>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">{{ __('draft.modal_close_button') }}</button>
...
<div class="modal fade" id="editProfilePictureModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <form action="{{ route('profilePicture.update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h1 class="modal-title fs-5" id="editProfilePictureModalLabel">{{ __('profilePicture.edit_button') }}</h1>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label for="picture" class="form-label">{{ __('profilePicture.title') }} (<span class="text-danger fw-bold">{{ __('profilePicture.format1') }}</span>) and <span class="fw-bold text-danger">{{ __('profilePicture.format2') }}</span> <span class="text-danger">*</span></label>
