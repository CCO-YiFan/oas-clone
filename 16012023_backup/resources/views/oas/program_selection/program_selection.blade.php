...
<div class="container mb-4">
    <div class="row">
        <div class="col-md-12">
            <h2 class="fw-bold mb-3">Program Selection</h2>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" role="progressbar" aria-label="Animated striped example" style="width: 14%" aria-valuenow="14" aria-valuemin="0" aria-valuemax="100" >Program Selection</div>
                <span class="text-primary ms-3 fw-bold">Next : Academic Record</span>
            </div>
        </div>
    </div>
</div>
