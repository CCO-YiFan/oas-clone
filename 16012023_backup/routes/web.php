...
use App\Http\Controllers\Program\programmeselectionController;
...
Route::prefix('user/')->middleware('auth')->group(function () {
    ...
    Route::controller(programmeselectionController::class)->prefix('program_selection')->name('program_selection.')->group(function () {
        Route::get('/', 'index')->name('program_selection');
        Route::post('/inputProgramme', 'inputProgramme')->name('inputProgramme');
        Route::post('/updateProgramme','updateProgramme')->name('updateProgramme');
    });

    Route::controller(supportingdocumentController::class)->prefix('supporting_document')->name('supporting_document.')->group(function () {
        Route::get('/', 'index')->name('supporting_document');
        Route::post('/insertDoc', 'insertDoc')->name('insertDoc');
    });
