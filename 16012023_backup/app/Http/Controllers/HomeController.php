    ...
    public function index()
    {
        ...
        if($application_status_log == null){
            ...
            if($application_status_id == 5|| $application_status_id == 6 || $application_status_id == 7 || $application_status_id == 8 || $application_status_id == 9 ||$application_status_id == 10 ||$application_status_id == 11 ){
                ...
                $programmePicked1 = ProgrammePicked::where('application_records_id',$applicationRecord->id)->where('choice_priorities_id',1)->first();
                $programmeRecord1 = ProgrammeRecord::where('id',$programmePicked1->programme_records_id)->first();
                $programme1 = Programme::where('id', $programmeRecord1->programmes_id)->first();
