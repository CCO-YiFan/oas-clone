...
class AcademicDetailController extends Controller
{
    ...
    public function create()
    {
        ...
        if($r->s_school_name == '' && $r->s_school_graduation =='' && $r->us_school_name == '' && $r->us_school_graduation == '' && $r->f_school_name == '' && $r->f_school_graduation == '' && $r->di_school_name == '' && $r->di_school_graduation == '' && $r->de_school_name == '' && $r->de_school_graduation == '' && $r->m_school_name == '' && $r->m_school_graduation == '' && $r->p_school_name == '' && $r->p_school_graduation == '' && $r->o_school_name =='' && $r->o_school_graduation ==''){
