...
class supportingdocumentController extends Controller
{
    ...
    public function insertDoc(Request $request)
    {
        ...
        $foundationtranscript = $request->file('foundation_transcript');
        $diplomatranscript = $request->file('diploma_transcript');
        $degreetranscript = $request->file('degree_transcript');
        $mastertranscript = $request->file('master_transcript');
        $phdtranscript = $request->file('phd_transcript');
